...
const DEFAULT_SERVICE_CATEGORIES = [
  ...
  },
  {
    ...
    examples: ["Launch materials", "Print, packaging, and event materials", "Social and digital creative"],
  ...
  },
  {
    ...
    examples: ["Workflow and automation planning", "SaaS tool recommendations", "Tool selection and setup"],
    cta: "Map My Systems",
    route: "conversation",
    visible: true,
    status: "active",
