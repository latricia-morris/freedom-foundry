...
const basePath = (process.env.BASE_PATH || '/freedom-foundry-expo').replace(/\/+$/, '');
...
const server = http.createServer((req, res) => {
  ...
  // A production web export takes priority when it exists. Unknown paths fall
  // back to Expo's single-page entry point so deep links and public shares
  // remain navigable after a refresh.
