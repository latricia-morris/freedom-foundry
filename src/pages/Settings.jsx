...
import { User as UserIcon, Trash2, AlertTriangle, Upload, Check, Mail, LifeBuoy } from 'lucide-react';
  ...
  return (
    <div className="max-w-2xl mx-auto animate-fade-in">
      ...
      <div className="editorial-container space-y-8">
        ...
        <section className="space-y-5">
          <div className="flex items-center gap-2">
            <LifeBuoy className="w-4 h-4 text-merlot" strokeWidth={1.5} />
            <h2 className="font-heading text-lg">Support & Feedback</h2>
          </div>
          <p className="text-sm text-[#1a1420]/65">
            Found a bug, or have an idea that would make the Foundry better? Send it to the team — screenshots welcome.
          </p>
          <Link
            to="/support"
