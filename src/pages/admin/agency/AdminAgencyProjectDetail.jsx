...
import {
  ...
  PAYMENT_OPS_LABELS, RELEASE_RULE_LABELS,
} from '@/lib/agency';
      ...
      <div className="dashboard-card mb-6 p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            {client && (
              <Link to={`/admin/agency/clients/${client.id}`} className="link-warm mt-2 inline-flex items-center gap-1.5">
                <ArrowLeft className="h-3 w-3 -rotate-180" /> Client page
              </Link>
            )}
          </div>
